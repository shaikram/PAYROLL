<nav class="navbar navbar-expand-lg navbar-dark bg-dark sticky-top">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto w-100 justify-content-end">
      <li class="nav-item profile_m" id="nav_item2">
        <div class="row">
          <div class="col-sm-3 col-md-3 col-lg-3 ">
            <div class="d-flex">
              <div class="p-2">
                <div class="mprofile_div">
                  <img src={{URL::asset('photo/'.$row->picture.'')}} class="profile_img">
                </div>
              </div>
              <div class="p-2">
      ...
      <li class="nav-item profile_li" id="nav_item3">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu bg-dark" aria-labelledby="navbarDropdown">
          ...
          <a class="dropdown-item text-light" href="{{ url('admin/admin-pass') }}">Password</a>
          <div class="dropdown-divider"></div>
          <a class="dropdown-item text-light" href="{{ url('admin/logout') }}">Logout</a>
        </div>
      </li>
    </ul>
  </div>
